 ...
 * @constructor
 */
function Error(statusCode, errorMessage, userMessage) {
  this.statusCode = statusCode || 500;
  this.statusMessage = Error.MESSAGES[this.code];
...
Error.OK = 200;
Error.MOVED_PERMANENTLY = 301;
Error.MOVED_TEMPORARILY = 302;
 ...
 * @type {object} of HTTP codes mapped to their string messages
 */
Error.MESSAGES = {
  '100': 'Continue',
